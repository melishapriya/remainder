...
class _InsurancePageState extends State<InsurancePage> with SingleTickerProviderStateMixin {
  ...
  backgroundColor: const Color.fromARGB(255, 234, 233, 236), // AppBar background color
  bottom: TabBar(
