...
class NetworkBillsPage extends StatefulWidget {
  const NetworkBillsPage({super.key});

  @override
  State<NetworkBillsPage> createState() => _NetworkBillsPageState();
}

class _NetworkBillsPageState extends State<NetworkBillsPage> with SingleTickerProviderStateMixin {
